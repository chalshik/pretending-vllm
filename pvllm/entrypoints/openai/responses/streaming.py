...
Upstream's file covers twenty-two event types; nineteen of them are tool, reasoning,
MCP or code-interpreter events reached only through a parser pvllm does not have. The
nine below are the whole sequence for a text generation, which is the only sequence
...
async def stream_responses(
    ...
    *,
    ...
    yield stamp("response.created", {"response": envelope("in_progress")})
    yield stamp("response.in_progress", {"response": envelope("in_progress")})
    yield stamp(
